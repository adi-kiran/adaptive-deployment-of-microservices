...
# df_test = pd.read_csv('../Dataset_ping/Attack/all_data/Attack' + fileno + '.csv')
for root, dirs, files in os.walk("../Dataset_ping/Attack/all_data/"):
    for filename in files:
        df_test = pd.read_csv("../Dataset_ping/Attack/all_data/" + filename)
        ...
        if res[0] == 0:
            pass
            # print("ATTACK detected", filename)
        else:
            print("No attack", filename)
# now = time.time()
